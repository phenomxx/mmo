...
int CPlayer::GetNeedForUp()
{
	...
	else if(AccData.Level >= 400) return 150000;
	else if(AccData.Level >= 500) return 200000;
	else if(AccData.Level >= 600) return 300000;
	else if(AccData.Level >= 700) return 400000;
	else if(AccData.Level >= 1000) return 500000;
	else if(AccData.Level >= 1100) return 600000;
	else if(AccData.Level >= 1200) return 700000;
	else return 200;
